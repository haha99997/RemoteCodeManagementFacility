...
//-----< virtual function for getChildren. Return an empty vector >---------
...
//-----< virtual function for getAttribs. Return an empty vector >---------

std::vector<std::pair<std::string, std::string>> AbstractXmlElement::getAttribs()
{
...
//-----< virtual function for getChildren. Return childrens for DocElement >---------

std::vector<std::shared_ptr<AbstractXmlElement>> DocElement::getChildren()
{
	std::vector < std::shared_ptr<AbstractXmlElement> > tmp(children_);
	return tmp;
};
...
//-----< virtual function for getChildren. Return childrens for TaggedElement >---------
...
//-----< return attributes from TaggedElement >----------

std::vector<std::pair<std::string, std::string>> TaggedElement::getAttribs()
{
	std::vector<std::pair<std::string, std::string>> result(attribs_);
	return result;
}
...
//-----< return attributes from ProcInstrElement >----------
...
//----< generate xml string for ProcInstrElement >-------------------------------
