...
* Build Process:
* --------------
*   devenv XMLDocumentModel.sln /debug rebuild /Project XmlElement
*
* Maintenance History:
* --------------------
* ver 1.6 : 13 Mar 15
* - Added getTag(), getChildren(), getAttributes(). Rewrite toString() for CommentElement
*   and ProcInstrElement
* ver 1.5 : 22 Feb 15
...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::string getTag() { return std::string(""); }
  ...
  public:
    ...
    virtual bool addChild(std::shared_ptr<AbstractXmlElement> pChild);
    virtual bool removeChild(std::shared_ptr<AbstractXmlElement> pChild);
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> getChildren() override;
  ...
  public:
    ...
    virtual bool addAttrib(const std::string& name, const std::string& value);
    virtual bool removeAttrib(const std::string& name);
	virtual std::vector<std::pair<std::string, std::string>> getAttribs() override;
	virtual std::string getTag() override { return tag_; }
    virtual std::string value();
    virtual std::string toString();
  private:
    std::string tag_;
